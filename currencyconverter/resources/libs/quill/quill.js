	      ...
	      handlers: {
	        ...
	        image: function image() {
	          ...
	          if (fileInput == null) {
				...
				fileInput.setAttribute('height', '200px');
				fileInput.setAttribute('width', '100%');
	            ...
	            fileInput.addEventListener('change', function () {
	              if (fileInput.files != null && fileInput.files[0] != null) {
						...
						/* Check File Size */
						var file_size = fileInput.files[0].size/1024;
						if(file_size > 1024){
							alert('Image size should not more than 1 MB');
							return false;
						}
